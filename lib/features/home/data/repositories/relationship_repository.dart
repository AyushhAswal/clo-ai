...
class LocalRelationshipRepository implements RelationshipRepository {
  // Singleton pattern for easy local state access across features
  static final LocalRelationshipRepository _instance =
      LocalRelationshipRepository._internal();
  factory LocalRelationshipRepository() => _instance;
  LocalRelationshipRepository._internal();
